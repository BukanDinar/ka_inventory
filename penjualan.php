 ...
 <!--main content start-->
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="arrow_carrot-2up_alt2"></i> Penjualan</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="admin.php">Home</a></li>
              <li><i class="arrow_carrot-2up_alt2"></i>Penjualn </li>
              <li><i class="fa fa-plus-square"></i>Edit Penjualan</li>
            </ol>
          </div>
        </div>
...
<?php
include ("konek.php");
$sql = "SELECT * FROM penjualan a, tabel_barang b WHERE a.kode_supplier = b.kode_supplier ORDER BY tgl_jual DESC";
        ...
        while($mhs = mysqli_fetch_array($query)){
            echo "<tr>";
            echo "<td>$no</td>";
            echo "<td align='right'>".date('l, d-F-y',strtotime($mhs['tgl_jual']))."</td>";
