        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-table"></i><a href="list-barang.php">List Barang</a></li>
              <li><i class="fa fa-edit"></i>Edit Barang</li>
            </ol>
          </div>
        </div>
...
$sql = "SELECT * FROM tabel_barang WHERE kode_barang=$kode_barang";
...
<body>
    ...
    <form action="proses-edit-barang.php" method="POST">
        <fieldset>
            <input type="hidden" name="kode_barang" value="<?php echo $mhs['kode_barang'] ?>" />
        <div class="form-group">
            <label for="nama_barang">Nama barang: </label>
            <input type="text" class="form-control" name="nama_barang" value="<?php echo $mhs['nama_barang'] ?>" />
        </div>
        <div class="form-group">
            <label for="stock">Stock: </label>
            <input type="text" class="form-control" name="stock" value="<?php echo $mhs['stock'] ?>"/>
        </div>
        <div class="form-group">
            <label for="stockmin">Stockmin: </label>
            <input type="text" class="form-control" name="stockmin" value="<?php echo $mhs['stockmin'] ?>"/>
        </div>
        <div class="form-group">
            <label for="harga_jual">Harga Jual: </label>
            <input type="text" class="form-control" name="harga_jual" value="<?php echo $mhs['harga_jual'] ?>"/>
        </div>
        <div class="form-group">
            <label for="harga_beli">Harga Beli: </label>
            <input type="text" class="form-control" name="harga_beli" value="<?php echo $mhs['harga_beli'] ?>"/>
        </div>
        <div class="form-group">
            <label for="disk">Diskon: </label>
            <input type="text" class="form-control" name="disk" value="<?php echo $mhs['disk'] ?>"/>
        </div> 
        </div>
         <div class="form-group">
