        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-table"></i>List Pelanggan</li>
            </ol>
          </div>
        </div>
...
<div class="panel panel-default">
        ...
        <fieldset>
         <div class="form-group">
                  <input type="hidden" type="text" name="kode_pelanggan" class="form-control">
                </div>
                <div class="form-group">
...
<?php
include ("konek.php");
$sql = "SELECT * FROM pelanggan ORDER BY nama_pelanggan";
        ...
        while($mhs = mysqli_fetch_array($query)){
            echo "<tr>";
            echo "<td>$no</td>";
            echo "<td>".$mhs['nama_pelanggan']."</td>";
            echo "<td>".$mhs['jenis_kelamin']."</td>";  
            echo "<td>".$mhs['alamat']."</td>"; 
            echo "<td>".$mhs['no_hp']."</td>";  
            echo "<td>Rp. ".number_format($mhs['saldo']).",-"."</td>";  
            echo "<td>";
            echo "<div class='btn-group'>";
            echo "<a class='btn btn-success' href='edit-pelanggan.php?kode_pelanggan=".$mhs['kode_pelanggan']."'><i class='icon_pencil-edit'></i></a> ";
            echo "<a class='btn btn-danger' href='hapus-pelanggan.php?kode_pelanggan=".$mhs['kode_pelanggan']."'><i class='icon_close_alt2'></i></a>";
            echo "</div>";
            echo "</td>";
