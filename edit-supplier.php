        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-table"></i><a href="list-supplier.php">List Supplier</a></li>
              <li><i class="fa fa-edit"></i>Edit Supplier</li>
            </ol>
          </div>
        </div>
...
<body>
    ...
    <form action="proses-edit-supplier.php" method="POST">
        <fieldset>
            <input type="hidden" name="kode_supplier" value="<?php echo $mhs['kode_supplier'] ?>" />
        <div class="form-group">
            <label for="nama_supplier">Nama Supplier: </label>
            <input type="text" class="form-control" name="nama_supplier" value="<?php echo $mhs['nama_supplier'] ?>" />
        </div>
        <div class="form-group">
            <label for="nama_kontak">Nama Kontak: </label>
            <input type="text" class="form-control" name="nama_kontak" value="<?php echo $mhs['nama_kontak'] ?>" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="hp" value="<?php echo $mhs['hp'] ?>"/>
        </div>
        <div class="form-group">
