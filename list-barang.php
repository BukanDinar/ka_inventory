        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-table"></i>List Barang</li>
            </ol>
          </div>
        </div>
...
<div class="panel panel-default">
        ...
        <fieldset>
         <div class="form-group">
                  <input type="hidden" type="text" name="kode_barang" class="form-control">
                </div>
                <div class="form-group">
...
$sql = "SELECT * FROM tabel_barang ORDER BY nama_barang";
        ...
        while($mhs = mysqli_fetch_array($query)){
            ...
            echo "<td>Rp. ".number_format($mhs['harga_jual']).",-"."</td>";
            echo "<td>Rp. ".number_format($mhs['harga_beli']).",-"."</td>";
            echo "<td><center>".number_format($mhs['disk'])."%"."</center></td>";  
            echo "<td>";
            echo "<div class='btn-group'>";
            echo "<a class='btn btn-success' href='edit-barang.php?kode_barang=".$mhs['kode_barang']."'><i class='icon_pencil-edit'></i></a> ";
            echo "<a class='btn btn-danger' href='hapus-barang.php?kode_barang=".$mhs['kode_barang']."'><i class='icon_close_alt2'></i></a>";
            echo "</div>";
            echo "</td>";
