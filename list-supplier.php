        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-table"></i>List Supplier</li>
            </ol>
          </div>
        </div>
...
<div class="panel panel-default">
        ...
        <fieldset>
         <div class="form-group">
                  <input type="hidden" type="text" name="kode_supplier" class="form-control">
                </div>
         <div class="form-group">
...
$sql = "SELECT * FROM supplier ORDER BY nama_supplier";
        ...
        while($mhs = mysqli_fetch_array($query)){
            ...
            echo "<td>".$mhs['nama_kontak']."</td>";  
            echo "<td>".$mhs['alamat']."</td>"; 
            echo "<td>".$mhs['hp']."</td>";  
            echo "<td>Rp. ".number_format($mhs['saldo']).",-"."</td>";  
            echo "<td>";
            echo "<div class='btn-group'>";
            echo "<a class='btn btn-success' href='edit-supplier.php?kode_supplier=".$mhs['kode_supplier']."'><i class='icon_pencil-edit'></i></a> ";
            echo "<a class='btn btn-danger' href='hapus-supplier.php?kode_supplier=".$mhs['kode_supplier']."'><i class='icon_close_alt2'></i></a>";
            echo "</div>";
            echo "</td>";
