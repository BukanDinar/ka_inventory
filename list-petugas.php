      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-table"></i>List Petugas</li>
            </ol>
          </div>
        </div>
          ...
          <div class="col-lg-12">
            <section class="panel">
              <div class="panel panel-default">
                ...
                <a class="btn btn-primary btn-4x" href="tambah-petugas.php">
                              <i class="glyphicon glyphicon-plus"> Tambah Petugas</i>
                            </a>
        ...
        <fieldset>
         <div class="form-group">
                  <input type="hidden" type="text" name="kode_petugas" class="form-control">
                </div>
         <div class="form-group">
...
<?php
include ("konek.php");
$sql = "SELECT * FROM petugas ORDER BY kode_petugas";
        ...
        while($mhs = mysqli_fetch_array($query)){
            echo "<tr>";
            echo "<td>$no</td>";
            echo "<td>".$mhs['nama_petugas']."</td>";
            echo "<td>".$mhs['jabatan']."</td>";  
            echo "<td>".$mhs['username']."</td>"; 
            echo "<td>".$mhs['password']."</td>";  
            echo "<td>";
            echo "<div class='btn-group'>";
            echo "<a class='btn btn-success' href='edit-petugas.php?kode_petugas=".$mhs['kode_petugas']."'><i class='icon_pencil-edit'></i></a> ";
            echo "<a class='btn btn-danger' href='hapus-petugas.php?kode_petugas=".$mhs['kode_petugas']."'><i class='icon_close_alt2'></i></a>";
            echo "</div>";
            echo "</td>";
